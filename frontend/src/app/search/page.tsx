...
import {
  ...
  Bookmark, BookmarkPlus, Trash2, ZoomIn, Heart, MapPinned,
} from "lucide-react";
...
export default function SearchPage() {
  ...
  }, [q, camera, lens, isoMin, isoMax, dateFrom, dateTo, colorSpace, focalMin, focalMax, hasGPS, isFavorited]);
  ...
  const hasFilters = camera || lens || isoMin || isoMax || dateFrom || dateTo || colorSpace ||
    focalMin || focalMax || hasGPS || isFavorited;
