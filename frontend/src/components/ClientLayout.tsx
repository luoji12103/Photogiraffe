  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 h-12 flex items-center justify-between px-3 sm:px-4 bg-zinc-950/80 backdrop-blur-md border-b border-zinc-800/50">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <Link href="/search" className="text-zinc-500 hover:text-zinc-300 transition-colors p-1" title="高级搜索">
          <Search className="w-4 h-4" />
        </Link>
        <Link href="/dashboard" className="text-zinc-500 hover:text-zinc-300 transition-colors p-1" title="Dashboard">
        ...
        <Link href="/profile" className="text-zinc-500 hover:text-zinc-300 transition-colors p-1" title="我的档案">
